...
BLOG_AUTHOR = "El Autoestopista, ResetReboot, Frux"  # (translatable)
BLOG_TITLE = "Astropirados"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://astropirados.space/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://astropirados.space/"
BLOG_EMAIL = "astropirados@astropirados.space"
BLOG_DESCRIPTION = "Blog de los Astropirados, un grupo de astronomos aficionados diferente"  # (translatable)
...
# before </head>
# (translatable)
EXTRA_HEAD_DATA = "<!-- FireStats --><script type='text/javascript' src='https://www.fernandezcordero.net:443/statistics/js/fs.js.php?site_id=3'></script>"
